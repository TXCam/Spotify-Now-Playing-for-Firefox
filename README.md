...
**IMPORTANT NOTE:**
*As of March 9, 2026, Spotify Developer accounts require a Spotify Premium subscription to access the Web API (that this extension runs off), and this program will no longer work with just a Spotify Free account*
...
- **Fast Marquee**: The marquee animation for overflowing text occasionally moves extremely quickly.
